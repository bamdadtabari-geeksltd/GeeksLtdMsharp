namespace Domain
{
    ...
    public partial class PasswordResetTicket : GuidEntity
    {
        ...
        /// <summary>
        /// Validates the data for the properties of this Password reset ticket and throws a ValidationException if an error is detected.<para/>
        /// </summary>
