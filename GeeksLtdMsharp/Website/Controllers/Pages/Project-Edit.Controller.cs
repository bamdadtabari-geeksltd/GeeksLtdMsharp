...
namespace Controllers
{
    ...
    public partial class ProjectEditController : BaseController
    {
        [Route("project/edit/{item:Guid?}")]
        public async Task<ActionResult> Index(vm.ProjectEdit info)
        {
        ...
        [HttpPost("ProjectEdit/Save")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Save(vm.ProjectEdit info)
        {
            try
            {
        ...
        [NonAction, OnBound]
        public async Task OnBound(vm.ProjectEdit info)
        {
        ...
        [NonAction]
        public async Task<bool> SaveInDatabase(vm.ProjectEdit info)
        {
...
namespace ViewModel
{
    [EscapeGCop("Auto generated code.")]
    #pragma warning disable
    public partial class ProjectEdit : IViewModel
    {
        [ValidateNever]
