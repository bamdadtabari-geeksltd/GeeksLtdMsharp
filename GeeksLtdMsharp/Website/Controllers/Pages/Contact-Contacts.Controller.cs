...
namespace Controllers
{
    ...
    public partial class ContactContactsController : BaseController
    {
        ...
        public async Task<ActionResult> Index(vm.ContactsList info)
        {
        ...
        [HttpPost("ContactsList/Delete")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Delete(vm.ContactsList info, [Bind(Prefix="list.item")] Contact item)
        {
            try
            {
        ...
        [NonAction, OnBound]
        public async Task OnBound(vm.ContactsList info)
        {
            info.Items = await GetSource(info)
                .Select(item => new vm.ContactsList.ListItem(item)).ToList();
        }
        ...
        async Task<IEnumerable<Contact>> GetSource(vm.ContactsList info, bool all = false)
        {
            ...
            IEnumerable<Contact> result = await query.GetList();
...
namespace ViewModel
{
    ...
    public partial class ContactsList : IViewModel
    {
        ...
        {
            public ListItem(Contact item) => Item = item;
