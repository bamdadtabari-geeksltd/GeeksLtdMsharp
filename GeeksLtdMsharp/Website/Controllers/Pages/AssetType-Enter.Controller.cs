...
namespace Controllers
{
    ...
    public partial class AssetTypeEnterController : BaseController
    {
        [Route("asset-type/enter/{item:Guid?}")]
        public async Task<ActionResult> Index(vm.AssetTypeForm info)
        {
        ...
        [HttpPost("AssetTypeForm/Save")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Save(vm.AssetTypeForm info)
        {
            try
            {
        ...
        [NonAction, OnBound]
        public async Task OnBound(vm.AssetTypeForm info)
        {
            info.Item = info.Item ?? new AssetType();
            
            if (Request.IsGet()) await info.Item.CopyDataTo(info);
        }
        
        [NonAction]
        public async Task<bool> SaveInDatabase(vm.AssetTypeForm info)
        {
...
namespace ViewModel
{
    [EscapeGCop("Auto generated code.")]
    #pragma warning disable
    public partial class AssetTypeForm : IViewModel
    {
        [ValidateNever]
