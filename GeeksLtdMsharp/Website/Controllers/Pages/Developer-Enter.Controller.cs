...
namespace Controllers
{
    ...
    public partial class DeveloperEnterController : BaseController
    {
        [Route("developer/enter/{item:Guid?}")]
        public async Task<ActionResult> Index(vm.DeveloperForm info)
        {
        ...
        [HttpPost("DeveloperForm/Save")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Save(vm.DeveloperForm info)
        {
            try
            {
        ...
        [NonAction, OnBound]
        public async Task OnBound(vm.DeveloperForm info)
        {
            info.Item = info.Item ?? new Developer();
            
            if (Request.IsGet()) await info.Item.CopyDataTo(info);
        }
        
        [NonAction]
        public async Task<bool> SaveInDatabase(vm.DeveloperForm info)
        {
...
namespace ViewModel
{
    [EscapeGCop("Auto generated code.")]
    #pragma warning disable
    public partial class DeveloperForm : IViewModel
    {
        [ValidateNever]
