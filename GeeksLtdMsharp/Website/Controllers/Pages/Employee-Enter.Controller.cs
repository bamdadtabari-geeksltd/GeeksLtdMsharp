...
namespace Controllers
{
    ...
    public partial class EmployeeEnterController : BaseController
    {
        [Route("employee/enter/{item:Guid?}")]
        public async Task<ActionResult> Index(vm.EmployeeForm info)
        {
        ...
        [HttpPost("EmployeeForm/Save")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Save(vm.EmployeeForm info)
        {
            try
            {
        ...
        [NonAction, OnBound]
        public async Task OnBound(vm.EmployeeForm info)
        {
            info.Item = info.Item ?? new Employee();
            
            if (Request.IsGet()) await info.Item.CopyDataTo(info);
        }
        
        [NonAction]
        public async Task<bool> SaveInDatabase(vm.EmployeeForm info)
        {
...
namespace ViewModel
{
    [EscapeGCop("Auto generated code.")]
    #pragma warning disable
    public partial class EmployeeForm : IViewModel
    {
        [ValidateNever]
        ...
        [DisplayName("ID Card")]
        public BlobViewModel IDCard { get; set; }
    }
}